...
// Bundled at build-time — no network request, bypasses all X-Frame-Options headers
import userManualHtml from '../assets/manuals/user-manual.html?raw';
import indusManualHtml from '../assets/manuals/indus-admin-manual.html?raw';
...
const Header: React.FC<HeaderProps> = ({ onMenuClick }) => {
    ...
    const manualHtml = loginType === 'indus' ? indusManualHtml : userManualHtml;
            ...
            <div className="h-full px-6 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative" ref={userMenuRef}>
                        ...
                        {/* Dropdown menu */}
                        <div className={`absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 transition-all duration-200 transform origin-top-right z-[101] ${
                            showUserMenu
            ...
            {showManual && createPortal(
                <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    <div className="flex flex-col w-full max-w-6xl h-[90vh] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl overflow-hidden border border-gray-200 dark:border-gray-700">
                        ...
                        {/* srcdoc = bundled HTML, bypasses all X-Frame-Options blocks */}
                        <iframe
                            srcDoc={manualHtml}
