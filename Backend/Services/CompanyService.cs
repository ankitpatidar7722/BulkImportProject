    ...
    public async Task<CompanyDto> GetCompanyAsync()
    {
        var query = @"
            SELECT TOP 1 
                ...
                OutSourceChallanRDLC, BufferGSMMinus, BufferGSMPlus, BufferSizeMinus, 
                BufferSizePlus, GenerateVoucherNoByProductionUnit, UnitwisePrintoutSetting, 
                ...
                PWOGangPrintRDLC, QCAndPackingSlip, IntegrationType, ItemSalesOrderBookingPrint, 
    ...
    public async Task<bool> UpdateCompanyAsync(CompanyDto company)
    {
        var query = @"
            ...
            SET CompanyName = @CompanyName,
                ...
                UnitwisePrintoutSetting = @UnitwisePrintoutSetting,
                ...
                GenerateVoucherNoByProductionUnit = @GenerateVoucherNoByProductionUnit,
                MaterialConsumptionDetailsFlage = @MaterialConsumptionDetailsFlage,
                BufferGSMMinus = @BufferGSMMinus,
                BufferGSMPlus = @BufferGSMPlus,
                BufferSizeMinus = @BufferSizeMinus,
                BufferSizePlus = @BufferSizePlus,
